...
import { Library, SlidersHorizontal, Star, Sparkles, BookOpen, Calendar, CalendarClock, Rocket, TrendingUp, Gauge, MessageCircle, GitCompareArrows, Target } from "lucide-react";
      ...
      <section className="space-y-3 animate-slide-up">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <QuickLink href="/economic-calendar" icon={<CalendarClock className="w-3.5 h-3.5" />} color="bg-indigo-500 hover:bg-indigo-600">経済指標</QuickLink>
